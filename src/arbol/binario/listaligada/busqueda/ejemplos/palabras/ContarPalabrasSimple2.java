...
public class ContarPalabrasSimple2 {
    ...
    public static void main(String[] args) {
        ...
        Palabra p;
        NodoBinarioBusqueda nodoInsert;
        Palabra pinsertada;

        for (String plb : cadenas) {
            p = new Palabra(plb);
        ...
        NodoBinarioBusqueda encuentra = abb.buscar(new Palabra ("nadie") );

        if (encuentra == null) {
            System.out.println("No esta");
        } else {
            System.out.println(  (Palabra) encuentra.getDato());
        }
